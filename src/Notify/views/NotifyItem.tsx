         ...
         >
            ...
            >
               ...
               <Box
                  flex={1}
               >
                  <Typography variant="body2" color={type && "#fff"} fontSize={small ? 13 : 15} mb={.4} fontWeight={600}>{title}</Typography>
                  {
                     content && <Typography color={type && "grey.200"} variant="subtitle1" fontSize={small ? 12 : 13} fontWeight={500} lineHeight="15px">
                        {content}
                     </Typography>
                  }
               </Box>
               ...
               {
                  (closeButton === undefined || closeButton) && <Box> 
