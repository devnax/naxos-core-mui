                    ...
                    {chunks[page - 1].map((category) => {
                        ...
                        return (
                            <Fragment key={category.id}>
                                ...
                                {isChecked &&
                                    categories
                                        .filter((cat) => category.id === cat.parentId)
                                        .map((subcat) => {
                ...
                {hideSearch !== false && (
                    <Autocomplete
                        ...
                        renderOption={(props, option, { selected }) => (
                            ...
                            >
                                <Checkbox size="small" sx={{ p: 0.4 }} style={{ marginRight: 8 }} checked={state.includes(option.id)} />
                                {option.name}
                            </li>
                        )}
                        value={[]}
                    ...
                    <>
                        ...
                        <Box sx={{ textAlign: 'right' }}>
                            {createText && (
                                ...
                                >
                                    {createParent ? 'PARENT - ' + categories.find((c) => c.id === createParent)?.name : 'SELECT PARENT'}
                                </Link>
                            )}
                        </Box>
                    </>
